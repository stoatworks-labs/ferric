/**
    ...
    `CFFGLPluginInfo` that Ferric.cpp registers at static-initialisation time.
    ...
    which build it is.
        ...
        strings Ferric.bundle/Contents/MacOS/Ferric | grep ferric
*/

extern "C" const char* FerricBuildStamp()
{
	return "ferric " FERRIC_VERSION " built " __DATE__ " " __TIME__;
}
